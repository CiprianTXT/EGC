...
{
    {
        ...
        RenderSimpleMesh(meshes["sphere"], shaders["LabShader"], modelMatrix, glm::vec3(0.4, 0.5, 0.1));
    }
...

    {
        ...
        RenderSimpleMesh(meshes["box"], shaders["LabShader"], modelMatrix, glm::vec3(0.2, 0.7, 0));
    }
    ...
    // Render the point light in the scene
    {
        ...
        RenderSimpleMesh(meshes["sphere"], shaders["Simple"], modelMatrix, glm::vec3(1,1,0));
    }
}
...
void Lab7::RenderSimpleMesh(Mesh *mesh, Shader *shader, const glm::mat4 & modelMatrix, const glm::vec3 &color)
{
    ...
    glUniform3fv(loc_light, 1, glm::value_ptr(lightPosition));
    ...
    glUniform3fv(loc_eye, 1, glm::value_ptr(eyePosition));
    ...
    glUniform1i(loc_shininess, (GLint)materialShininess);
