...
void Lab5::Update(float deltaTimeSeconds)
{
    ...
    {
        glm::mat4 modelMatrix = glm::mat4(1);
        modelMatrix = glm::translate(modelMatrix, glm::vec3(0.0f, 2.5f, 0));
    ...
    {
        glm::mat4 modelMatrix = glm::mat4(1);
        modelMatrix = glm::translate(modelMatrix, glm::vec3(4.0f, 2.5f, 2));
        modelMatrix = glm::rotate(modelMatrix, RADIANS(30.5f), glm::vec3(1, 1, 0));
        modelMatrix = glm::scale(modelMatrix, glm::vec3(2, 0, 0));
        RenderMesh(meshes["box"], shaders["VertexNormal"], modelMatrix);
    }
