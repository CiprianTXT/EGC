...
void Lab1::Update(float deltaTimeSeconds)
{
    ...
    // Render the object
    RenderMesh(meshes["box"], glm::vec3(xCoord, yCoord, zCoord), glm::vec3(0.5f));

    // Render the object again but with different properties
    RenderMesh(meshes["box"], glm::vec3(-1, yCurrentBounce, 0));
    ...
    switch (currentMesh) {
    case 0:
        RenderMesh(meshes["teapot"], glm::vec3(5, 0, -1), glm::vec3(4));
        break;
    case 1:
        RenderMesh(meshes["sphere"], glm::vec3(5, 0, -1), glm::vec3(4));
        break;
    case 2:
        RenderMesh(meshes["box1"], glm::vec3(5, 0, -1), glm::vec3(4));
        break;
    }
    ...
    if (isBouncing) {
        ...
        if (yCurrentBounce >= yEndBounce) {
            isAscending = false;
        }
        if (!isAscending && yCurrentBounce == yStartBounce) {
            isBouncing = false;
        }
    }
}
...
void Lab1::OnKeyPress(int key, int mods)
{
    ...
    if (key == GLFW_KEY_F) {
        ...
        isColorChanged = isColorChanged ? false : true;
    }
